"""
Launch the handoff_asr_eval/ smoke test. See entrypoint_handoff_smoketest.py.

Usage:
    python sagemaker/launch_handoff_smoketest.py
"""
import sagemaker
...
estimator = PyTorch(
    entry_point="entrypoint_handoff_smoketest.py",
    ...
    base_job_name="safety-layers-handoff-smoketest",
    max_run=1 * 60 * 60,  # small-scale smoke test, should be well under an hour
    environment={
        "HF_TOKEN": hf_token,
